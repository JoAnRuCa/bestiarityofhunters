<section class="comments-area bg-transparent">
    ...
    @auth
        <form action="{{ route('comments.store') }}" method="POST" onsubmit="return enviarComentario(event, this)" class="mb-10">
            ...
            <textarea name="comentario" rows="3" required 
                class="w-full p-4 rounded-lg bg-white border border-[#6B8E23]/20 shadow-md focus:ring-1 focus:ring-[#6B8E23] outline-none transition-all placeholder:text-gray-400" 
    ...
    <div id="comments-wrapper" class="flex flex-col bg-transparent">
