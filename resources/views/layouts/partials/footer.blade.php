...
<footer class="bg-[#F4EBD0] px-8 pt-12 pb-8 mt-auto border-t border-[#6B8E23]/10">
    <div class="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-center gap-16">

      {{-- Logo del Footer con Redirección Dinámica --}}
      <div class="flex items-center gap-3">
          <a href="{{ auth()->check() && auth()->user()->role === 'admin' ? route('admin.users.index') : route('home') }}">
              <img class="w-[260px] h-[150px] object-contain rounded" 
