    ...
    <div class="w-[95%] max-w-7xl mx-auto mt-12 mb-12 p-8 rounded-3xl shadow-2xl bg-[#F4EBD0] border border-[#6B8E23]/20 text-[#2F2F2F]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
            ...
            <div class="lg:col-span-2 space-y-12">
                ...
                {{-- SEGUNDA LÍNEA DIVISORIA INTERNA --}}
                <div class="w-full h-px bg-[#6B8E23]/30 my-8"></div>
                ...
                <section>
                    ...
                    <div id="playstyle_container" class="bg-white border-2 border-[#6B8E23]/10 p-6 rounded-2xl shadow-sm transition-all duration-300">
                        <textarea id="playstyleField" name="playstyle" rows="6" 
                            placeholder="Describe how to play this build, combos, or positioning..." 
...
{{-- MODAL --}}
<div id="modal" class="hidden fixed inset-0 bg-black/70 backdrop-blur-md z-[9999] flex items-center justify-center p-4 cursor-pointer">
    <div class="bg-[#F4EBD0] w-full max-w-xl rounded-[2.5rem] shadow-2xl border-4 border-[#6B8E23] flex flex-col overflow-hidden max-h-[85vh] cursor-default">
        <div class="bg-[#6B8E23] p-6 text-white flex justify-between items-center">
            ...
            <button type="button" onclick="closeModal()" class="text-white font-bold text-3xl hover:scale-110 transition-transform">&times;</button>
        </div>
        <div class="p-5 bg-white/30 border-b border-[#6B8E23]/10">
            <input id="searchInput" type="text" placeholder="Filter by name or skill..." class="w-full bg-white border-2 border-[#6B8E23]/30 rounded-2xl py-4 px-6 font-bold outline-none focus:border-[#6B8E23] transition-all text-[#2F2F2F]">
        </div>
