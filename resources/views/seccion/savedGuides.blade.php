...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 mb-20">
    ...
    {{-- TODO EL CONTENIDO DENTRO DEL DIV PERGAMINO --}}
    <div class="bg-[#F4EBD0] rounded-xl shadow-2xl border border-[#6B8E23]/30 overflow-hidden p-8 md:p-12">
        ...
        {{-- Panel de Filtros (ahora dentro del fondo) --}}
        <div class="mb-12">
            <x-filter-panel 
        ...
        @else
            {{-- Grid de 2 columnas como estaba antes --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                @foreach($savedData as $item)
                    @php $guide = $item->guide; @endphp
                    
                    <div class="group p-6 flex justify-between items-start border-b border-[#6B8E23]/10 md:border md:border-[#6B8E23]/5 md:rounded-lg transition-all hover:bg-[#6B8E23]/5 relative">
                        ...
                        <div class="flex flex-col items-center gap-6 min-w-[60px]">
                            <div class="save-container">
                                ...
                                <span class="btn-text hidden">Saved</span>
...
<style>
    /* Anulamos el posicionamiento absoluto del botón de guardado solo aquí */
    .save-container { 
