...
@section('content')
<div class="flex flex-col gap-8 mt-12 mb-12">
    
    {{-- BLOQUE 1: LA GUÍA --}}
    <div class="w-[60%] max-w-4xl mx-auto p-8 bg-[#F4EBD0] rounded-lg shadow-lg">
    ...
    {{-- BLOQUE 2: COMENTARIOS (Separado pero con el mismo estilo) --}}
    <div class="w-[60%] max-w-4xl mx-auto p-8 bg-[#F4EBD0] rounded-lg shadow-lg">
